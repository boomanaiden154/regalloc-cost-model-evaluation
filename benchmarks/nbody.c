...
static int64_t energyCalls = 0;
static int64_t offset_momentumCalls = 0;
static int64_t scale_bodiesCalls = 0;
...
int main(int argc, char ** argv)
{
  ...
  float energy1 = energy(NBODIES, bodies);
  ...
  float energy2 = energy(NBODIES, bodies);
#ifndef CALL_COUNT_INSTRUMENTATION
  printf ("%.9f\n", energy2);
#else
  printf("advance,%ld\n", advanceCalls);
